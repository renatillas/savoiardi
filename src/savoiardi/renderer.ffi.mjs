...
/** @param {THREE.WebGLRenderer} renderer @param {boolean} enabled @returns {void} */
...
/** @param {THREE.WebGLRenderer} renderer @param {number} width @param {number} height @returns {void} */
export function setRendererSize(renderer, width, height) {
  renderer.setSize(width, height);
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} pixelRatio @returns {void} */
export function setPixelRatio(renderer, pixelRatio) {
  renderer.setPixelRatio(pixelRatio);
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} width @param {number} height @param {number} pixelRatio @returns {void} */
...
/** @param {THREE.WebGLRenderer} renderer @param {boolean} color @param {boolean} depth @param {boolean} stencil @returns {void} */
...
/** @param {THREE.WebGLRenderer} renderer @param {number} alpha @returns {void} */
export function setClearAlpha(renderer, alpha) {
  renderer.setClearAlpha(alpha);
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} color @param {number} alpha @returns {void} */
export function setClearColor(renderer, color, alpha) {
  renderer.setClearColor(color, alpha);
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {boolean} autoClear @returns {void} */
export function setAutoClear(renderer, autoClear) {
  renderer.autoClear = autoClear;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {boolean} autoClearColor @returns {void} */
export function setAutoClearColor(renderer, autoClearColor) {
  renderer.autoClearColor = autoClearColor;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {boolean} autoClearDepth @returns {void} */
export function setAutoClearDepth(renderer, autoClearDepth) {
  renderer.autoClearDepth = autoClearDepth;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {boolean} autoClearStencil @returns {void} */
export function setAutoClearStencil(renderer, autoClearStencil) {
  renderer.autoClearStencil = autoClearStencil;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {string} outputColorSpace @returns {void} */
export function setOutputColorSpace(renderer, outputColorSpace) {
  renderer.outputColorSpace = outputColorSpace;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} toneMapping @returns {void} */
export function setToneMapping(renderer, toneMapping) {
  renderer.toneMapping = toneMapping;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} exposure @returns {void} */
export function setToneMappingExposure(renderer, exposure) {
  renderer.toneMappingExposure = exposure;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} scale @returns {void} */
export function setTransmissionResolutionScale(renderer, scale) {
  renderer.transmissionResolutionScale = scale;
  return renderer;
}

/** @param {THREE.WebGLRenderer} renderer @param {number} shadowMapType @returns {void} */
...
/** @param {THREE.WebGLRenderer} renderer @param {(timestamp: number) => void} onFrame @returns {void} */
