...
/** @param {number} width @param {number} height @param {number} widthSegments @param {number} heightSegments @returns {THREE.PlaneGeometry} */
export function createPlaneGeometry(width, height, widthSegments, heightSegments) {
  return new THREE.PlaneGeometry(width, height, widthSegments, heightSegments);
}

/** @param {number} radiusTop @param {number} radiusBottom @param {number} height @param {number} radialSegments @returns {THREE.CylinderGeometry} */
...
/** @param {number} radius @param {number} tube @param {number} radialSegments @param {number} tubularSegments @returns {THREE.TorusGeometry} */
export function createTorusGeometry(radius, tube, radialSegments, tubularSegments) {
  return new THREE.TorusGeometry(radius, tube, radialSegments, tubularSegments);
}

/** @param {number} innerRadius @param {number} outerRadius @param {number} segments @returns {THREE.RingGeometry} */
...
/** @param {number} radius @param {number} tube @param {number} tubularSegments @param {number} radialSegments @returns {THREE.TorusKnotGeometry} */
export function createTorusKnotGeometry(radius, tube, tubularSegments, radialSegments) {
  return new THREE.TorusKnotGeometry(radius, tube, tubularSegments, radialSegments);
}

/** @param {number} radius @param {number} length @param {number} capSegments @param {number} radialSegments @returns {THREE.CapsuleGeometry} */
export function createCapsuleGeometry(radius, length, capSegments, radialSegments) {
  return new THREE.CapsuleGeometry(radius, length, capSegments, radialSegments);
}

/** @param {THREE.BufferGeometry} geometry @returns {THREE.BufferGeometry} */
